...
splice_empty(void **state) {
	...
	D_LIST(push_back)(&other_list, (void*)5);
	// position 1
	D_LIST(splice)(&list, NULL, &other_list, NULL);
	// so list 0 3 4 5 1 2
	assert_int_equal(D_LIST(size)(&list), 3);
	assert_int_equal(D_LIST(get_cell)(&list, 0)->v_data, 3);
	assert_int_equal(D_LIST(get_cell)(&list, 1)->v_data, 4);
	assert_int_equal(D_LIST(get_cell)(&list, 2)->v_data, 5);
	assert_ptr_not_equal(D_LIST(get_cell)(&list, 0), D_LIST(get_cell)(&other_list, 0));
	assert_ptr_not_equal(D_LIST(get_cell)(&list, 1), D_LIST(get_cell)(&other_list, 1));
	assert_ptr_not_equal(D_LIST(get_cell)(&list, 2), D_LIST(get_cell)(&other_list, 2));
	assert_ptr_equal(D_LIST(get_cell)(&list, 0)->v_data, D_LIST(get_cell)(&other_list, 0)->v_data);
	assert_ptr_equal(D_LIST(get_cell)(&list, 1)->v_data, D_LIST(get_cell)(&other_list, 1)->v_data);
	assert_ptr_equal(D_LIST(get_cell)(&list, 2)->v_data, D_LIST(get_cell)(&other_list, 2)->v_data);
	D_LIST(destroy)(&list);
